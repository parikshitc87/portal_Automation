class RegistrationPage:
	form_title = 'text = Create account >> nth = 0'
	...
	page_elements = [form_title, create_button, first_name_label, first_name_input_field, last_name_label,
	                 last_name_input_field, email_label, email_input_field,
